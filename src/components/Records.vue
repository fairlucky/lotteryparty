<style>
    ...
    .el-table__body-wrapper,.el-tabs--card,.el-tabs__content{
...
<template>
    <div class="container-fluid">
        <el-card shadow="hover">
            ...
            <el-tabs height="250" highlight-current-row stripe v-model="activeName" type="card"
                     @tab-click="handleClick">
                <el-tab-pane label="我的记录" name="myRecord">
                    <el-table :default-sort="{prop: 'gameid', order: 'descending'}" :data="myRecord"
                              :highlight-current-row="highlight" style="width: 100%">
                ...
                <el-tab-pane label="历史中奖记录" name="history">
                    <el-table :data="history" :highlight-current-row="highlight" style="width: 100%">
                        ...
                        <el-table-column align="center" header-align="center" prop="lucky_man_1" label="一等奖">
                        </el-table-column>
                        <el-table-column align="center" header-align="center" prop="lucky_man_2" label="二等奖">
                        </el-table-column>
                        <el-table-column align="center" header-align="center" prop="lucky_man_3" label="三等奖">
                        </el-table-column>
